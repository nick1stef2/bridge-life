...
const targets = [
  ...
  { source: "src/assets/pbn/2026-08-30.pbn", tournamentId: "aot-26425-2026-08-30", expectedBoards: 32 },
  { source: "src/assets/pbn/2026-09-01.pbn", tournamentId: "aot-26432-2026-09-01", expectedBoards: 32 },
];
